...
/**
 * Created by Ebillson GJ on 7/22/2017.
 */


public class MovieArrayAdapterLand extends ArrayAdapter<Movie> {
    ...
    public MovieArrayAdapterLand(Context context, List<Movie> movies){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       Picasso.with(getContext()).load(movie.getBackdropPath()).into(ivImage);
        ...
        //no Picasso.with(getContext()).load(movie.getPosterPath()).resize(150, 0).into(ivImage);//recent comment
        Picasso.with(getContext()).load(movie.getBackdropPath()).resize(250, 250).
